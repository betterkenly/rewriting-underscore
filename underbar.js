(function() {
  ...
  _.indexOf = function(array, target){
    ...
    // return result;
    var result = -1;
    _.each(array, function(each, index){
  ...
  //   // values into a new array of values. _.pluck() is solved for you
  //   // as an example of this.
  //   return _.map(collection, function(each){
  //     return each[key];
  //   })
  // };
  // _.pluck = function(collection, key ){
  //   return _.each(collection, function(each){
  //     return each[key];
  //   });
  // }
    _.pluck = function(collection, key ){
  ...
  // _.reduce = function(array, iterator, accumulator){
    ...
    // var accumulatorIsUndefined = arguments.length < 3;
    // _.each(array, function(current, index, array ){
    //   if(accumulatorIsUndefined){
    //     accumulatorIsUndefined = false;
    //     accumulator = current;
    //   }else{
    //     accumulator = iterator(accumulator, current, index, array);
    //   }
    // });
    // return accumulator;
//     var accumulatorIsUndefined = arguments.length < 3;
...
_.reduce = function(collection, iterator, accumulator ){
  var accIsUndefined = arguments.length < 3;
  _.each(collection, function(current, index){
    if( accIsUndefined ){
      accumulator = current;
      accIsUndefined = false;
    }else{
      accumulator = iterator(accumulator, current, index);
    }
  });
  return accumulator;
};
...
_.contains = function(collection , target ){
  return _.reduce(collection, function(wasFound, each ){
      if(wasFound){
        return true;
      }
      return each === target;
  ...
  _.shuffle = function(array) {
    // var copied = Array.prototype.slice.call(array);
    // var result = [];

    // for( var i = 0 ; i < array.length ; i++ ){
    //   var randomIndex = Math.floor(Math.random() * (copied.length - 1)) ;
